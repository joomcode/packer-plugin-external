---
description: >
  The external data source is used to communicate with external commands.
...
You can find pre-built binary releases of the plugin [here](https://github.com/joomcode/packer-plugin-external/releases).
...
directory. Upon successful compilation, a `packer-plugin-external` plugin
